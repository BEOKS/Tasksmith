...
def build_processor_prompt(task_dir: Path, tasksmith_dir: Path) -> str:
    return (
        ...
        "Never use spawn_agent or any other interactive sub-agent or delegation tool as a substitute. "
        "If a required non-interactive run cannot be launched, stop and report the blocker."
    )
